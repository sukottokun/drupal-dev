...
class __TwigTemplate_72a25ba261bc71365114e886ddfbcd909b6714b0c603a9dffcdf73d40b20118a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"sf-toolbar-block\">
        ...
        // line 35
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (((isset($context["icon"]) || array_key_exists("icon", $context))) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed(($context["icon"] ?? null), 35, $this->source), "")) : ("")), "html", null, true);
        echo "</div>
        <div class=\"sf-toolbar-info\">";
        // line 36
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (((isset($context["text"]) || array_key_exists("text", $context))) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed(($context["text"] ?? null), 36, $this->source), "")) : ("")), "html", null, true);
        echo "</div>
    </div>
...
";
    ...
    {
        return new Source("", "@webprofiler/Collector/performance_timing.html.twig", "/app/modules/contrib/devel/webprofiler/templates/Collector/performance_timing.html.twig");
    }
